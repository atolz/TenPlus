...
const NavItem = (props) => {
  return (
    <div className="flex flex-1 items-center p-8 cursor-pointer hover:bg-gray-100">
      ...
      {props.type && <i className={"bi bi-chevron-right ml-auto"} style={{ fontSize: "1.3em", color: "#a8abc1" }}></i>}
    </div>
  );
};
