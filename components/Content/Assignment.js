...
const Assignment = () => {
  return (
    <div className="p-4 border flex items-center rounded-3xl">
      ...
      <button className="bg-red-50 text-xl whitespace-nowrap text-red-400 rounded-full h-10 font-semibold flex px-4 items-center justify-center cursor-pointer ml-auto">Start now</button>
    </div>
  );
};
